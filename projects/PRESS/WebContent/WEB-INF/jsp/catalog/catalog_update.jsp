...
<input type="hidden" name="updateCondition.catid" value="${updateCondition.catid }"/>
<body class="easyui-layout">
	<div region="center" title="修改${cattypnam }分类" style="overflow: hidden;">
		<table cellpadding="0" cellspacing="0" border="0"  width="100%" class="easyui-bg">
			...
			<tbody>
				<tr >
					...
					<td><input type="text" 
					           name="updateCondition.catnam" 
					           value="${updateCondition.catnam }" 
					           size="50" 

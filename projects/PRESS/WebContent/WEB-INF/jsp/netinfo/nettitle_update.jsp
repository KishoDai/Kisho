...
<body class="easyui-layout">
	<div region="center" title="修改网站标题" style="overflow: hidden;" class="easyui-bg">
		<table cellpadding="0" cellspacing="0" border="0"  width="100%" class="easyui-bg">
			...
			<tbody>
				<tr >
					<th class="ui-widget-header ">网站标题</th>
					<td><input type="text" name="paramvalue" value="${paramvalue}" style="width:300px;"
					 class="easyui-validatebox"
						       missingMessage="请输入网站标题" 
						       required="true"/></td>
				</tr>
				<tr >
